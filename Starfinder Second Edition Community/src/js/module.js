...
var modPf2 = (function () {
    ...
    const global_attributes_by_category = {
        ...
        , "skills": ["acrobatics","arcana","athletics","computers","crafting","deception","diplomacy","intimidation","medicine","nature","occultism","performance","piloting","religion","society","stealth","survival","thievery"]
    ...
    const global_npc_attributes = {
        basics: ["npc_type","level","temperament","size","traits","perception","senses","languages","acrobatics","acrobatics_notes","arcana","arcana_notes","athletics","athletics_notes","crafting","crafting_notes","computers","computers_notes","deception","deception_notes","diplomacy","diplomacy_notes","intimidation","intimidation_notes","medicine","medicine_notes","nature","nature_notes","occultism","occultism_notes","performance","performance_notes","piloting","piloting_notes","religion","religion_notes","society","society_notes","stealth","stealth_notes","survival","survival_notes","thievery","thievery_notes","strength_modifier","dexterity_modifier","constitution_modifier","intelligence_modifier","wisdom_modifier","charisma_modifier","armor_class","armor_class_notes","saving_throws_fortitude","saving_throws_reflex","saving_throws_will","saving_throws_notes","hit_points_max","hit_points_notes","immunities","weaknesses","resistances","speed","speed_notes","spell_attack","spell_dc","focus_points_max"]
    };
    // Misc
        ...
        getRepSecIds(JSON.parse(JSON.stringify(Object.values(global_repsecs))), (repsec_agr) => {
            ...
            getAttrs(all_fields, (values) => {
                ...
                setAttrs(big_update, {silent: true}, ()=>{
                    console.log(`%c Starfinder Second Edition Community Sheet: ${(values["character_name"] || "Unnamed character")} updated (${new Date() - debug_start}ms)`, "color:purple;font-size:14px;");
                    if(callback) {
                        callback();
                    }
                });
    ...
    const versioning = function(callback) {
        ...
        getAttrs(fields, (values) => {
            ...
            if (version_character === version_sheet) {
                console.log(`%c Starfinder Second Edition Community Sheet: ${(values["character_name"] || "Unnamed character")}, version ${version_character}`, "color:purple;font-size:14px;");
                if(callback) {
                    callback();
                }
    ...
    const versioningUpdateTo2_01 = function(versioning_values, versioningDoneUpdating) {
        console.log(`%c Starfinder Second Edition Community Sheet: ${(versioning_values["character_name"] || "Unnamed character")} updating to version 2.01`, "color:purple;font-size:13px;font-style:italic;");
    ...
    const versioningUpdateTo2_05 = function(versioning_values, versioningDoneUpdating) {
        console.log(`%c Starfinder Second Edition Community Sheet: ${(versioning_values["character_name"] || "Unnamed character")} updating to version 2.05`, "color:purple;font-size:13px;font-style:italic;");
        if((versioning_values["sheet_type"] || "").toLowerCase() === "npc") {
    ...
    const versioningUpdateTo3_02 = function(versioning_values, versioningDoneUpdating) {
        console.log(`%c Starfinder Second Edition Community Sheet: ${(versioning_values["character_name"] || "Unnamed character")} updating to version 3.02`, "color:purple;font-size:13px;font-style:italic;");
        /*
    ...
    const versioningUpdateTo3_03 = function(versioning_values, versioningDoneUpdating) {
        console.log(`%c Starfinder Second Edition Community Sheet: ${(versioning_values["character_name"] || "Unnamed character")} updating to version 3.03`, "color:purple;font-size:13px;font-style:italic;");
        /*
    ...
    const versioningUpdateTo3_042 = (versioning_values, versioningDoneUpdating) => {
        console.log(`%c Starfinder Second Edition Community Sheet: ${(versioning_values["character_name"] || "Unnamed character")} updating to version 3.042`, "color:purple;font-size:13px;font-style:italic;");
    ...
    const versioningUpdateTo3_06 = function(versioning_values, versioningDoneUpdating) {
        console.log(`%c Starfinder Second Edition Community Sheet: ${(versioning_values["character_name"] || "Unnamed character")} updating to version 3.06`, "color:purple;font-size:13px;font-style:italic;");
    ...
    const versioningUpdateTo3_08 = function(versioning_values, versioningDoneUpdating) {
        console.log(`%c Starfinder Second Edition Community Sheet: ${(versioning_values["character_name"] || "Unnamed character")} updating to version 3.08`, "color:purple;font-size:13px;font-style:italic;");
    ...
    const versioningUpdateTo3_09 = function(versioning_values, versioningDoneUpdating) {
        console.log(`%c Starfinder Second Edition Community Sheet: ${(versioning_values["character_name"] || "Unnamed character")} updating to version 3.09`, "color:purple;font-size:13px;font-style:italic;");
        /*
    ...
    const updateSpellDrop = function(section, rawdata) {
        ...
        try{
            ...
            cdata = {};
            console.log(`%c Starfinder Second Edition Community Sheet: drop on ${section}: no valid data`, "color:red;font-size:14px;");
        }
        if(_.isEmpty(cdata)) {
            console.log(`%c Starfinder Second Edition Community Sheet: drop on ${section}: empty data`, "color:red;font-size:14px;");
        } else {
                ...
                if(character_object["compendium_spells"] && character_object["compendium_spells"].length) {
                    ...
                    character_object.compendium_spells.forEach(spell => {
                        ...
                        try {
                            ...
                            spell_data = {};
                            console.log(`%c Starfinder Second Edition Community Sheet: completeCharacterWithCompendium: no valid data in compendium data for this spell: ${(spell["name"] || "")}`, "color:red;font-size:14px;");
                        }
    ...
    const updateNpcDrop = function(rawdata) {
        ...
        try{
            ...
            cdata = {};
            console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: no valid data`, "color:red;font-size:14px;");
        }
        if(_.isEmpty(cdata)) {
            console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: empty data`, "color:red;font-size:14px;");
        } else {
    ...
    const calcNpcDrop = function (cdata,values) {
        ...
        if(cdata["data-lore"]) {
            try{
                ...
                obj_array = [];
                console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: invalid lore`, "color:red;font-size:14px;");
            }
            if(obj_array.length) {
        ...
        if(cdata["data-items"]) {
            try{
                ...
                obj_array = [];
                console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: invalid items`, "color:red;font-size:14px;");
            }
            if(obj_array.length) {
                obj_array.forEach((obj) => {
        ...
        if(cdata["data-interaction-abilities"]) {
            try{
                ...
                obj_array = [];
                console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: invalid interaction abilities`, "color:red;font-size:14px;");
            }
            if(obj_array.length) {
                obj_array.forEach((obj) => {
        ...
        if(cdata["data-free-actions-reactions"]) {
            try{
                ...
                obj_array = [];
                console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: invalid actions reactions`, "color:red;font-size:14px;");
            }
            if(obj_array.length) {
                obj_array.forEach((obj) => {
        ...
        if(cdata["data-melee-strikes"]) {
            try{
                ...
                obj_array = [];
                console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: invalid melee strikes`, "color:red;font-size:14px;");
            }
            if(obj_array.length) {
                obj_array.forEach((obj) => {
        ...
        if(cdata["data-ranged-strikes"]) {
            try{
                ...
                obj_array = [];
                console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: invalid ranged strikes`, "color:red;font-size:14px;");
            }
            if(obj_array.length) {
                obj_array.forEach((obj) => {
        ...
        if(cdata["data-actions-activities"]) {
            try{
                ...
                obj_array = [];
                console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: invalid actions activities (offensive or proactive abilities)`, "color:red;font-size:14px;");
            }
            if(obj_array.length) {
                obj_array.forEach((obj) => {
        ...
        if(cdata["data-spellinnate"]) {
            try{
                ...
                obj_array = [];
                console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: invalid innate spells`, "color:red;font-size:14px;");
            }
            if(obj_array.length) {
                is_spellcaster = true;
                obj_array.forEach((obj) => {
        ...
        if(cdata["data-spellfocus"]) {
            try{
                ...
                obj_array = [];
                console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: invalid focus spells`, "color:red;font-size:14px;");
            }
            if(obj_array.length) {
                is_spellcaster = true;
                obj_array.forEach((obj) => {
        ...
        if(cdata["data-cantrip"]) {
            try{
                ...
                obj_array = [];
                console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: invalid cantrips`, "color:red;font-size:14px;");
            }
            if(obj_array.length) {
                is_spellcaster = true;
        ...
        if(cdata["data-spell"]) {
            try{
                ...
                obj_array = [];
                console.log(`%c Starfinder Second Edition Community Sheet: npcdrop_data: invalid spell`, "color:red;font-size:14px;");
            }
            if(obj_array.length) {
                is_spellcaster = true;
                let spellvl = 1;
